...
canvas_color = Button(win,text = "canvas\ncolor",width = 8,bg = canvas_col,fg = "black",command = lambda : mode('canvas'))
pen_color = Button(win,text = "pen\ncolor",width = 8,bg = pen_col,fg = "white",command = lambda : mode('pen'))
fill_color = Button(win,text = "fill\ncolor",width = 8,bg = fill_col,fg = "black",command = lambda : mode('fill'))
circle = Button(win,text = "○",bg = "white",fg = "black",width = 8,command = lambda : mode("cir"))
rect = Button(win,text = "□",bg = "white",fg = "black",width = 8,command =lambda : mode("rect"))
poly = Button(win,text = "△",bg = "white",fg = "black",width = 8,command =lambda : mode("poly"))
...
fill_color.grid(row = 3,column = 0)
circle.grid(row = 3,column = 1)
rect.grid(row = 3,column = 2)
poly.grid(row = 3,column = 3)
